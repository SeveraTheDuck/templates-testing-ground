...
```bash
git clone https://github.com/SeveraTheDuck/templates-testing-ground
cd templates-testing-ground
...
Use [GitHub Issues](https://github.com/SeveraTheDuck/templates-testing-ground/issues).
